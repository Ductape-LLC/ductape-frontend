...
import { createAppConstant, fetchAppConstant } from '@/api/appsClient';
          ...
          <div className="px-16 p-10">
            ...
            <div>
              {constants.map((constant: any) => (
                <div
                  key={constant._id}
                  className="border rounded bg-white h-[110px] flex items-center px-7 justify-between mt-7"
                >
                  <p className="font-bold text-lg">Constant One</p>
                  <p className="text-xs font-semibold">6743hfh473738374hr</p>
                  <p className="text-xs font-semibold">Value 1 Here</p>
                </div>
              ))}
            </div>
          </div>
